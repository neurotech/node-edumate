...
edumate.query = function (config, sql, options) {
  return new Promise(function (resolve, reject) {
    if (typeof config === 'undefined' || typeof config.libpath === 'undefined' || typeof config.drivername === 'undefined' || typeof config.url === 'undefined') {
      reject(new Error('Incomplete config. Please supply a `config` object containing the correct libpath, drivername, and url values.'));
    }
